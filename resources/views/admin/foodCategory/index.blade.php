<x-AdminApp-layout>
    ...
    <div class="m-auto w-4/5 py-12">
        ...
        <div class="float">
            <a href="foodCategory/create" class="italic text-xl bold text-pink-600 ">
        ...
        <div class="w-5/6 py-10">
            ...
            <div class="m-auto py-6 divide-black">
                <div class="float-right ">
                    <a class="pb-2 italic text-green-600" href="foodCategory/{{$food->id}}/edit">ویرایش &rarr;</a>

                    <form action="foodCategory/{{$food->id}}" method="POST">
                        @csrf
                        @method('delete')
                        <button type="submit" class="pb-2 pt-3  italic text-red-600 ">حذف &rarr;</button>
                    </form>
                </div>
                <div class="flex justify-center space-x-20 rounded-lg">
                    <img src="{{ asset('storage/adminFood/'.$food->image_path) }}" class="w-2/12 mb-4 shadow-xl rounded-full" alt="{{$food->title}}">
