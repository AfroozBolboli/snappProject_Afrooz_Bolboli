        ...
        <div class="flex justify-center pt-10">
            <form action="/admin/foodparty" method="post" enctype="multipart/form-data">
                ...
                <div class="block text-center">
                    ...
                    <input type="text" class="block shadow-5xl mb-10 p-2 w-80 italic text-right placeholder-pink-400" name="food_id" value="{{$food->food_id}}" placeholder="آیدی غذا">

                    <input type="number" class="block shadow-5xl mb-10 p-2 w-80 italic text-right placeholder-pink-400" name="discount" value="{{$food->discount}}" placeholder="مقدار تخفیف">
