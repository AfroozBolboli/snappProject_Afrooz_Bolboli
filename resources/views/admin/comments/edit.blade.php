<x-AdminApp-layout>
    <div class="m-auto w-4/8 py-12 text-center">
        ...
        <div class="flex justify-center space-x-5 my-5">
            <div>
                <input type="radio" value="1" name="deletePermission" class="rounded bg-gray-100 focus:ring-pink-500 text-pink-500">
                <label>پاک کردن نظر</label><br>
                <input type="radio" value="0" name="deletePermission" class="rounded bg-gray-100 focus:ring-pink-500 text-pink-500" checked>
