        ...
        <div class="flex justify-center pt-20">
            <form action="/seller/food/{{$food->id}}" method="post" enctype="multipart/form-data">
                ...
                <div class="block text-center">
                    ...
                    <input type="text" class="block shadow-5xl mb-3 p-2 w-80 italic text-right placeholder-pink-400" name="name" value="{{$food->name}}" placeholder="اسم غذا">
                    ...
                    <input type="number" class="block shadow-5xl mb-10 p-2 w-80 italic text-right placeholder-pink-400" name="price" value="{{$food->price}}" placeholder="قیمت غذا">
